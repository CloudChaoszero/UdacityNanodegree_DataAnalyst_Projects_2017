...
CLF_PICKLE_FILENAME = "../Output-Files/my_classifier.pkl"
DATASET_PICKLE_FILENAME = "../Output-Files/my_dataset.pkl"
FEATURE_LIST_FILENAME = "../Output-Files/my_feature_list.pkl"
